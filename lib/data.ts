...
export const videoVoices: VideoVoice[] = [
  // AUTHORITATIVE & POWERFUL
  {
    ...
    id: "zeus",
    gender: "Male",
    description: "Deep, powerful, and commanding.",
    sampleUrl: "/audio/zeus.mp3",
  },
  {
    name: "Sophie",
    id: "athena",
    gender: "Female",
    description: "Intelligent, clear, and authoritative.",
    sampleUrl: "/audio/athena.mp3",
  },
  {
    name: "Julian",
    id: "jupiter",
    gender: "Male",
    description: "Regal and steady broadcaster feel.",
    sampleUrl: "/audio/jupiter.mp3",
  },
  {
    name: "Hera",
    id: "hera",
  ...
  // FRIENDLY & SOFT
  {
    ...
    id: "luna",
    gender: "Female",
    description: "Soft, friendly, and inviting.",
  ...
  },
  {
    ...
    id: "apollo",
    gender: "Male",
    description: "Bright, enthusiastic, and approachable.",
    sampleUrl: "/audio/apollo.mp3",
  },
  {
    name: "Lily",
    id: "iris",
  ...
  // ELEGANT & CLASSICAL
  {
    ...
    sampleUrl: "/audio/callista.mp3",
  },
  {
    name: "Emma",
    id: "cordelia",
    gender: "Female",
    description: "Refined and gentle flow.",
    sampleUrl: "/audio/cordelia.mp3",
  },
  {
    name: "Clara",
    id: "ophelia",
  ...
  },
  {
    ...
    sampleUrl: "/audio/janus.mp3",
  },
  {
    name: "Oliver",
    id: "odysseus",
    gender: "Male",
    description: "Crafty and storytelling-oriented.",
    sampleUrl: "/audio/odysseus.mp3",
  },
  {
    name: "Orpheus",
    id: "orpheus",
...
export const captionStyles = [
  {
    label: "Youtuber",
    className:
      "text-yellow-400 font-extrabold drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]",
  },
  {
    label: "Supreme",
    className: "italic text-white font-black tracking-tighter bg-red-600 px-2",
  },
  {
    label: "Neon",
    className:
      "text-green-400 font-bold drop-shadow-[0_0_10px_rgba(74,222,128,0.8)]",
  },
  { label: "Glitch", className: "text-white font-bold mix-blend-difference" },
  {
    label: "Fire",
    className:
      "text-transparent bg-clip-text bg-gradient-to-t from-red-600 to-yellow-400 font-black",
  },
  {
    label: "Futuristic",
    className:
      "text-cyan-400 font-mono tracking-widest border-b-2 border-cyan-400",
  },
